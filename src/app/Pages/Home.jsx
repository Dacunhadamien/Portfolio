    ...
    <div>
        ...
        <div className="md:hover:scale-105 transform duration-500 ease-in-out font-montserrat flex justify-center items-center flex-col bg-cover bg-center size-11/12 text-white rounded-3xl shadow-xl my-10 bg-backgroundImage bg-black">
          ...
          <Link to="/Wip" className="flex justify-center ">
            <TiPencil
              ...
              className="font-Alt md:size-20 size-16 hover:scale-110 hover:text-custom-yellow transform duration-500 ease-in-out border-8 border-double rounded-3xl border-custom-yellow"
            />
          </Link>
          <div className="flex flex-col items-center justify-center">
            ...
            <a href="#HTML/CSS">
              <FaArrowDown
                aria-label="arrowdown_icon"
                className="md:size-16 animate-bounce size-12 text-custom-yellow rounded-3xl hover:text-custom-red my-10 hover:scale-110 transform duration-500"
              />
            </a>
          </div>
        </div>
      ...
      <div className="text-white flex justify-center items-center flex-col text-center pt-10 pb-5 bg-black" id="bot">
        ...
        <Link to="/Wip" className="flex justify-center ">
          <TiPencil
            aria-label="pencil_icon"
            className="font-Alt md:size-20 size-16 mt-10 hover:scale-125 hover:text-custom-red transform duration-300 ease-out border-8 border-double rounded-3xl border-custom-yellow"
          />
        </Link>
      </div>
    </div>
