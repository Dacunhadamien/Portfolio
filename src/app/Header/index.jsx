...
function Header() {
  return (
    <div className="header font-montserrat flex md:justify-between justify-center items-center text-custom-green font-semibold py-10" id="top">
      <h1 className="font-Alt text-4xl mx-16 bg-left-bottom bg-gradient-to-r text-custom-yellow from-custom-yellow to-custom-green bg-[length:100%_2px] bg-no-repeat">Acceuil</h1>
